...
yourinstallation\examples\MSInternetExplorer:\> Execute targetServer domain username passwd
 
4. If you get any ACCESS_DENIED exceptions, please go through the main "readme.htm" at the root folder of the installation.

5. If you see a IE window on the target server...don't read any further....goto 6.

okay ! so you don't see any window of IE, don't panic...it's just a matter of DCOM settings...On the target server... type "DCOMCNFG" on run.

	.click on "Component Services" and keep clicking till you reach list showing "DCOM config".
	.Open this folder and select "Internet Explorer".
	.Do a right click and select properties.
	.A dialog will open showing you all the IE stuff...just go to the last tab , saying "Identity". 
